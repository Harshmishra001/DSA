...
// THIS QN DOES NOT HAVE BRUTE FORCE APPROACH THIS IS IMPLEMENTATION BASED QN SO ONLY HAVE OPTIMAL APPROACH
...
// Space Complexity: O(n) { Extra Space used for storing traversal in the ans array }.
 class SpiralMatrix {
    ...
    public static List<Integer> printSpiral(int[][] mat) {
        ...
        int m = mat[0].length; // no. of columns   (always write col like this)
